...
module.exports = class AskResources extends ConfigFile {
    ...
    getSkillMetaSrc(profile) {
        // falling back to default path for hosted skills
        const defaultPath = `./${CONSTANTS.FILE_PATH.SKILL_PACKAGE.PACKAGE}`;
        return this.getProperty(['profiles', profile, 'skillMetadata', 'src']) || defaultPath;
    }
